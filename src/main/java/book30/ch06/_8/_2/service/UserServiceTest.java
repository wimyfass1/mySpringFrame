...
import static book30.ch06._8._2.service.UserServiceImpl.MIN_LOGCOUNT_FOR_SILVER;
import static book30.ch06._8._2.service.UserServiceImpl.MIN_RECCOMEND_FOR_GOLD;
...
@ContextConfiguration(locations={"../ch06_8_2-applicationContext.xml", "../../../ch06-applicationContext.xml"})
public class UserServiceTest {
	...
	public void transactionSync3() {
		...
		assertThat(userDao.getCount(), is(0));
		for(User user : users) userDao.add(user); // 사용자를 다시 추가하여 본 테스트 실행과 무관하게 readOnlyTransactionAttribute()가 올바른 환경에서 수행될 수 있도록 해줌
	}
