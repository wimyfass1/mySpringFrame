package book30.ch06._5._3.learning;
...
public class PointcutExpressionTest {
	...
	public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
		...
		pointcut.setExpression("execution(public int book30.ch06._5._3.learning.Target.minus(int, int) throws java.lang.RuntimeException)");
	...
	public void pointcut() throws Exception {
		...
		tagetClassPointcutMatches("execution(* book30.ch06._5._3.learning.Target.*(..))", true, true, true, true, true, false);
		tagetClassPointcutMatches("execution(* book30.ch06._5._3.learning.*.*(..))", true, true, true, true, true, true);
		tagetClassPointcutMatches("execution(* book30.ch06._5._3..*.*(..))", true, true, true, true, true, true);
		tagetClassPointcutMatches("execution(* book30..*.*(..))", true, true, true, true, true, true);
