...
import book30.ch11._6._2.service.MemberServiceTxAnnotation;
import book30.ch11.domain.Member;

@SuppressWarnings("unused")
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations="../../applicationContext.xml")
public class RollbackTestWithTxAnnotation {
	@Autowired
	private MemberServiceTxAnnotation memberServiceTxAnnotation;
	
	@Before
	public void init() {
	    this.memberServiceTxAnnotation.deleteAll();
	}
	...
	public void addTransactionTestWithXmlAopConfiguration() {
		...
		memberServiceTxAnnotation.addEachMemberListWithTransaction(memberList);
	}
}